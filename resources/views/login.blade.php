...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login Admin BIP</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Login page of Business Incubation Project " name="description" />
    ...
    <body class=" login">
        ...
        <div class="copyright"> <?php echo Date("Y") ?> © Business Incubation Project. Admin Dashboard. </div>
        <!--[if lt IE 9]>
